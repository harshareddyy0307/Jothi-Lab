...
const Payments = () => {
  ...
  useEffect(() => {
    fetchPayments();
  }, [page, limit, paymentMethod]); // Trigger immediately on pagination and dropdown change
      ...
      <div className="grid gap-6 md:grid-cols-4">
        ...
        <div className="md:col-span-1 rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-navy-850 dark:bg-navy-900 flex flex-col justify-between">
          <div>
            ...
            <h3 className="text-2xl font-extrabold text-coral-500 mt-2">₹{totalCollected.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
          </div>
        ...
        <div className="flex flex-col gap-4 border-b border-slate-100 p-5 sm:flex-row sm:items-center sm:justify-between dark:border-navy-850">
          ...
          <div className="relative flex items-center max-w-xs w-full">
            ...
            <input
              ...
              value={search}
              onChange={(e) => { setSearch(e.target.value); setPage(1); fetchPayments(); }}
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 text-sm text-navy-800 dark:divide-navy-850 dark:text-navy-200">
              {loading ? (
                ...
                payments.map((p, idx) => {
                  // Descending serial numbers: totalItems - index of row
